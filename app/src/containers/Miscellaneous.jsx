...
const Miscellaneous = ({ miscellaneous, setMiscellaneousInfo }) => (
  <Card>
    <Helper text="Tell us what you like to do.<br/>Playing hockey, listening to podcasts, playing video games, going to the cinema to watch old movies, watch Ted conferences etc." />
